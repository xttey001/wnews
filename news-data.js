...
const newsData = {
  "2026-04-12": {
    ...
    "bajie_conclusion": {
      "optimal_action": "轻仓观望：40-50%仓位为主，AI算力ETF回调后低吸，工程机械ETF逢低布局，回避科创芯片/创业板高位",
      "optimal_etfs": "AI算力ETF(512930) > 工程机械ETF(159542) > 闪迪映射ETF > 有色ETF(159871)企稳后",
      "win_rate": "~62%（贝叶斯后验+沙僧白龙马融合）",
      "max_drawdown": "-8.0%（止损线）",
      "holding_period": "1-3天（等创业板回踩确认后加仓）",
      "overall": {
        "best_action": "轻仓观望：40-50%仓位为主，AI算力ETF回调后低吸，工程机械ETF逢低布局，回避科创芯片/创业板高位",
        "best_etfs": "AI算力ETF(512930) > 工程机械ETF(159542) > 闪迪映射ETF > 有色ETF(159871)企稳后",
        "win_rate": "~62%（贝叶斯后验+沙僧白龙马融合）",
        "stop_loss": "-8.0%（止损线）"
      },
      "沙僧信号": {
    ...
    "evolution_v4": {
      ...
      "tang_rules": [],
      "arbitration_notes": [
        "🙏 唐僧仲裁：悟空看空(地缘缓和预期升温，市场情绪趋于谨慎乐观) 但 八戒建议买入(轻仓观望：40-50%仓位为主，AI算力ETF回调后低吸，工程机械ETF逢低布局，回避科创芯片/创业板高位) → 方向矛盾，降置信度20%，建议观望或极轻仓试探"
      ]
    },
    "wukong_judgment": {
    ...
    "tang_sanzang": {
      "仓位": "30-50% 轻仓",
      "最终行动": "轻仓观望：40-50%仓位为主，AI算力ETF回调后低吸，工程机械ETF逢低布局，回避科创芯片/创业板高位",
      "仲裁矛盾": [
        "🙏 唐僧仲裁：悟空看空(地缘缓和预期升温，市场情绪趋于谨慎乐观) 但 八戒建议买入(轻仓观望：40-50%仓位为主，AI算力ETF回调后低吸，工程机械ETF逢低布局，回避科创芯片/创业板高位) → 方向矛盾，降置信度20%，建议观望或极轻仓试探"
      ],
      ...
      "_raw": {
        "final_action": "轻仓观望：40-50%仓位为主，AI算力ETF回调后低吸，工程机械ETF逢低布局，回避科创芯片/创业板高位",
        "final_win_rate": "~62%",
        "optimal_etfs": "AI算力ETF(512930) > 工程机械ETF(159542) > 闪迪映射ETF > 有色ETF(159871)企稳后",
        "max_drawdown": "-8.0%（止损线）",
        "arbitration_notes": [
        ...
        "module_summary": {
          ...
          "沙僧": "情绪:平稳(买入5%) | 注入1条经验",
          "白龙马": "主力:拉升(可信度1.0)",
          "八戒": "行动:轻仓观望：40-50%仓位为主，AI算力ETF回调后低吸，工程机械ETF逢低布局，回避科创芯片/创业板高位 胜率:~62%（贝叶斯后验+沙僧白龙马融合） | 注入3条经验"
        },
        "experience_applied": {
          "悟空": [
            "WX-001"
